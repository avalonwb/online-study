...
class myorderlist extends React.Component {
  state = {
    ...
    orderlist: null // 用来存储当前登录用户的所有订单数据
  }
  ...
  getorders(type, pageIndex, pageSize) {
    ...
    requset.get(url).then(res => {
      ...
      // 如果处理成功则将数据赋值给state.orderlist
      this.setState({
        orderlist: res.message.orderList,
        OrderTypeList: res.message.OrderTypeList,
            ...
            <Col span='18'>
              <div className={css.allclass_content}>
                ...
                <div className={css.nav}>
                  <div>
                    <span className={css.col_md_6 + ' ' + css.fleft}>
                      课程信息
                    </span>
                    <span className={css.col_md_4 + ' ' + css.fleft}>
                      <em>订单金额</em>
                      <em>实付款</em>
                      <em>交易状态</em>
                    </span>
                    <span className={css.col_md_2 + ' ' + css.fleft}>
                      交易操作
                    </span>
                  </div>
                    ...
                    this.state.orderlist.map((item, index) => (
                      <div className={css.content} key={index}>
                        <div className={css.item}>
                          <div className={css.time_orderid}>
                            <span>{fmtDate(item.add_time)}</span> 订单号：
                            {item.order_no}
                          </div>
                          <div className={css.item_content}>
                            <Row>
                                ...
                                <Row>
                                  <Col span='8'>
                                    <div className={css.col_md_2}>
                                      <img
                                        src={item.order_goods_list[0].img_url}
                                        width='100%'
                                        alt=''
                                      />
                                    </div>
                                  ...
                                  <Col span='16'>
                                    <div
                                      className={
                                        css.item_cent + ' ' + css.col_md_6
                                      }>
                                      <div className={css.title}>
                                        {item.order_goods_list[0].goods_title}
                                      </div>
                                      ...
                                      <div className={css.text}>
                                        课程打分{' '}
                                        <em>
                                          {item.order_goods_list[0].lesson_star}
                                          星
                                        </em>
                                      </div>
                                      <div className={css.cont}>
                                        有效截止日期：
                                        {fmtDate(
                                          item.order_goods_list[0].timeout_time
                                        )}
                                      </div>
                                    </div>
                                  </Col>
                                          ...
                                          <Row key={index} key={index1}>
                                            ...
                                            <Col span='15' offset='1'>
                                              <div
                                                ...
                                                <div className={css.text}>
                                                  课程打分{' '}
                                                  <em>{item1.lesson_star}星</em>
                                                </div>
                                                <div className={css.cont}>
                                                  有效截止日期：
                                                  {fmtDate(item1.timeout_time)}
                                                </div>
                                              </div>
                                            </Col>
                                          </Row>
                              ...
                              <Col span='7'>
                                <div
                                  className={css.col_md_4 + ' ' + css.lab_info}>
